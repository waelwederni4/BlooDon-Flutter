...
class FirstScreenTheme extends StatefulWidget {
  final List<FirstScreenModel> pages;
  final Color bgColor;
  ...
  @override
  FirstScreenThemeState createState() => FirstScreenThemeState();
}

class FirstScreenThemeState extends State<FirstScreenTheme> {
  ...
  Widget _showPageData(FirstScreenModel page) {
    return Padding(
